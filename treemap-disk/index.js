...
module.exports = Event.extend(function Base(container, config) {
  ...
  render: function (data, config) {
    ...
    cfg.series.forEach(function (element) {
      element.data = data;
      element.levels = cfg.levels;
    });
    
    cfg.tooltip.formatter = function (info) {
      ...
      return [
          '<div class="tooltip-title">' + Chart.format.encodeHTML(treePath.join('/')) + '</div>',
          'Disk Usage: ' + Chart.format.addCommas(value) + ' KB',
      ].join('');
    }
